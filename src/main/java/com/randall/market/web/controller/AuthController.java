...
import com.randall.market.domain.dto.AuthenticationRequest;
import com.randall.market.domain.dto.AuthenticationResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthenticationResponse> createToken (@RequestBody AuthenticationRequest request){
        try{
            ...
            UserDetails userDetails = randallUserDetailsService.loadUserByUsername(request.getUsername());
